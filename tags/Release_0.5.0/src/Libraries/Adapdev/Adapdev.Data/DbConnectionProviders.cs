...
namespace Adapdev.Data {
	...
	[Serializable]
	public class DbConnectionProviders : IDictionary, ICloneable {
		#region Member Variables
		private const int DEFAULT_CAPACITY = 16;

		private string[] keys;
		private DbConnectionProvider[] values;
		private int count;
		...
		#region Constructors
		/// <summary>
		///		Initializes a new instance of the <see cref="DbConnectionProviders"/> class that is empty, 
		///		has the default initial capacity and is sorted according to the <see cref="IComparable"/> interface 
		///		implemented by each key added to the <b>DbConnectionProviders</b>.
		/// </summary>
		public DbConnectionProviders() {
			keys = new string[DEFAULT_CAPACITY];
			values = new DbConnectionProvider[DEFAULT_CAPACITY];
		...
		///		interface implemented by each key added to the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <param name="capacity">The initial number of elements that the <see cref="DbConnectionProviders"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public DbConnectionProviders(int capacity) {
			if (capacity < 0)
				throw new ArgumentOutOfRangeException("capacity", capacity, "Initial capacity cannot be less than zero.");

			keys = new string[capacity];
			values = new DbConnectionProvider[capacity];
			comparer = Comparer.Default;
		}
		...
		/// </param>
		public DbConnectionProviders(IComparer comparer) : this() {
			if (comparer != null)
		...
		/// <param name="capacity">The initial number of elements that the <see cref="DbConnectionProviders"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public DbConnectionProviders(IComparer comparer, int capacity) : this(capacity) {
			if (comparer != null)
				this.comparer = comparer;
		}

		/// <summary>
		///		Initializes a new instance of the <see cref="DbConnectionProviders"/> class that contains 
		...
		///		<para>-or-</para>
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="DbConnectionProviders"/>.</para>
		///	</exception>
		public DbConnectionProviders(IDictionary d) : this(d, null) {}
		...
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="DbConnectionProviders"/>.</para>
		///	</exception>
		public DbConnectionProviders(IDictionary d, IComparer comparer)
		...
		#region Properties
		/// <summary>
		///		Gets and sets the value associated with a specific key in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <value>
		///		The <see cref="DbConnectionProvider"/> associated with <paramref name="key"/> in the <see cref="DbConnectionProviders"/>,
		...
		///		Callers must either catch this exception, or call the <see cref="DbConnectionProviders.Contains"/> method first to
		///		see if the key exists.
		/// </remarks>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="DbConnectionProviders"/>.
		/// </exception>
		/// <exception cref="NullReferenceException">
		///		<paramref name="key"/> is not found in the <see cref="DbConnectionProviders"/>.
		/// </exception>
		object IDictionary.this[object key] {
			...
			set {
				...
				if (!(value is DbConnectionProvider))
					throw new ArgumentException("The value must be of type: " + typeof(DbConnectionProvider).FullName, "value");

				this[(string)key] = (DbConnectionProvider)value;
			}
		}
		...
		///		<paramref name="key"/> is not found in the <see cref="DbConnectionProviders"/>.
		/// </exception>
		public virtual DbConnectionProvider this[string key] {
			get {
		...
		/// <summary>
		///		Gets or sets the capacity of the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <value>The number of elements that the <see cref="DbConnectionProviders"/> can contain.</value>
			...
			set {
				...
				if (value != keys.Length) {
					if (value > 0) {
						...
						DbConnectionProvider[] newValues = new DbConnectionProvider[value];
		...
		/// <summary>
		///		Gets the number of elements contained in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <value>The number of elements contained in the <see cref="DbConnectionProviders"/>.</value>
		...
		/// <summary>
		///		Gets a value indicating whether the <b>DbConnectionProviders</b> has a fixed size.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="DbConnectionProviders"/> has a fixed size; otherwise, <b>false</b>.
		...
		/// <summary>
		///		Gets a value indicating whether the <b>DbConnectionProviders</b> is read-only.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="DbConnectionProviders"/> is read-only; otherwise, <b>false</b>.
		///		The default is <b>false</b>.
		/// </value>
		...
		/// <summary>
		///		Gets a value indicating whether access to the <b>DbConnectionProviders</b> is
		///		synchronized (thread-safe).
		/// </summary>
		/// <value>
		///		<b>true</b> if access to the the <see cref="DbConnectionProviders"/> is 
		...
		/// <summary>
		///		Gets the keys in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the keys in the <see cref="DbConnectionProviders"/>.</value>
		/// <remarks>
		///		<para>The <see cref="ICollection"/> is a read-only view of the keys in the 
		///		<see cref="DbConnectionProviders"/>. Modifications made to the underlying <b>DbConnectionProviders</b>
		...
		///		of the <b>DbConnectionProviders</b>.</para>
		///		<para>Similar to <see cref="DbConnectionProviders.GetKeyList"/>, but returns an <b>ICollection</b>
		...
		/// <summary>
		///		Gets an object that can be used to synchronize access to the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <value>An object that can be used to synchronize access to the <see cref="DbConnectionProviders"/>.</value>
		public virtual object SyncRoot {
			get { return this; }
		}

		/// <summary>
		///		Gets the values in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the values in the <see cref="DbConnectionProviders"/>.</value>
		/// <remarks>
		...
		///		of the <b>DbConnectionProviders</b>.</para>
		///		<para>Similar to <see cref="DbConnectionProviders.GetValueList"/>, but returns an <b>ICollection</b>
		///		instead of an <see cref="IList"/>.</para>
		/// </remarks>
		...
		///		<para>-or-</para>
		///		<para>Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="DbConnectionProviders"/>.</para>
		///		<para>-or-</para>
		...
		void IDictionary.Add(object key, object value) {
			...
			this.Add((string)key, (DbConnectionProvider)value);
		}
		...
		/// <summary>
		///		Removes all elements from the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="DbConnectionProviders"/> is read-only.</para>
		///		<para>-or-</para>
		...
		/// <summary>
		///		Determines whether the <b>DbConnectionProviders</b> contains a specific key.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="DbConnectionProviders"/>.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		The <paramref name="key"/> is not of a type supported by the <see cref="DbConnectionProviders"/>.
		/// </exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="DbConnectionProviders"/> contains an element with the specified key; 
		///		otherwise, <b>false</b>.
		///	</returns>
		...
		/// <summary>
		///		Copies the <see cref="DbConnectionProviders"/> elements to a one-dimensional <see cref="System.Array"/>
		///		instance at the specified index.
		/// </summary>
		/// <param name="array">
		///		The one-dimensional <see cref="System.Array"/> that is the destination of the
		///		<see cref="DictionaryEntry"/> objects copied from <see cref="DbConnectionProviders"/>.
		...
		///		<para>-or-</para>
		///		<para>The number of elements in the source <see cref="DbConnectionProviders"/> is greater than the 
		///		available space from <paramref name="arrayIndex"/> to the end of the destination <paramref name="array"/>.</para>
		/// </exception>
		/// <exception cref="InvalidCastException">
		///		The type of the source <see cref="DbConnectionProviders"/> cannot be cast automatically to the type
		...
		/// <summary>
		///		Gets the value at the specified index of the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the value to get.</param>
		/// <returns>The value at the specified index of the <see cref="DbConnectionProviders"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="DbConnectionProviders"/>.
		/// </exception>
		public virtual DbConnectionProvider GetByIndex(int index) {
		...
		/// <summary>
		///		Returns an <see cref="IEnumerator"/> that can iterate through the <b>DbConnectionProviders</b>.
		/// </summary>
		...
		///		<b>DbConnectionProviders</b>.		
		/// </summary>
		/// <returns>An <see cref="IDictionaryEnumerator"/> for the <see cref="DbConnectionProviders"/>.</returns>
		public virtual IDictionaryEnumerator GetEnumerator() {
			return new SortedListEnumerator(this, 0, count, SortedListEnumerator.DictEntry);
		}

		/// <summary>
		///		Gets the key at the specified index of the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the key to get.</param>
		/// <returns>The key at the specified index of the <see cref="DbConnectionProviders"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="DbConnectionProviders"/>.
		/// </exception>
		...
		///		Gets the keys in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the keys in the <see cref="DbConnectionProviders"/>.</returns>
		/// <remarks>
		...
		///		of the <b>DbConnectionProviders</b>.</para>
		///		<para>Similar to <see cref="DbConnectionProviders.Keys"/>, but returns an <b>IList</b>
		...
		///		Gets the values in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the values in the <see cref="DbConnectionProviders"/>.</returns>
		/// <remarks>
		...
		///		of the <b>DbConnectionProviders</b>.</para>
		///		<para>Similar to <see cref="DbConnectionProviders.Values"/>, but returns an <b>IList</b>
		///		instead of an <see cref="ICollection"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Returns the zero-based index of the specified key in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="DbConnectionProviders"/>.</param>
		/// <returns>
		...
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <remarks>
		///		<para>The elements of a <see cref="DbConnectionProviders"/> are sorted by the keys either 
		///		according to a specific <see cref="IComparer"/> implementation specified when the 
		///		<see cref="DbConnectionProviders"/> is created or according to the <see cref="IComparable"/> 
		...
		///		it is inserted into <see cref="DbConnectionProviders"/> in the correct sort order, and the 
		...
		///		removed from the <see cref="DbConnectionProviders"/>.</para>
		///		<para>This method uses a binary search algorithm; therefore, the average execution time is 
		///		proportional to Log2(<i>n</i>), where <i>n</i> is <see cref="DbConnectionProviders.Count"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Removes the element with the specified key from the <b>DbConnectionProviders</b>.
		/// </summary>
		...
		/// </exception>
		/// <remarks>
		///		If the <see cref="DbConnectionProviders"/> does not contain an element with the specified key,
		///		the <b>DbConnectionProviders</b> remains unchanged. No exception is thrown.
		/// </remarks>
		...
		/// <summary>
		///		Sets the capacity to the actual number of elements in the <b>DbConnectionProviders</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="DbConnectionProviders"/> is read-only.</para>
		///		<para>-or-</para>
		...
		[Serializable]
			private class SyncSortedList : DbConnectionProviders, IDictionary {
			private DbConnectionProviders list;
			private object root;
			...
			public override DbConnectionProvider this[string key] {
				get {
					lock (root)
						return list[key];
				}
			...
			public override DbConnectionProvider GetByIndex(int index) {
				lock (root)
		...
		[Serializable]
			...
			private DbConnectionProviders list;
			private string key;
			private DbConnectionProvider value;
			private int index;
			...
			public virtual DbConnectionProvider Value {
				get {
					CheckState();
					return value;
				}
		...
		[Serializable]
			...
			bool IList.Contains(object value) {
				...
				return list.ContainsValue((DbConnectionProvider)value);
			}
			...
			object IList.this[int index] {
				...
				set {
					...
					list.SetByIndex(index, (DbConnectionProvider)value);
				}
			}

			public virtual DbConnectionProvider this[int index] {
				get {
					return list.GetByIndex(index);
				}
				set {
			...
			int IList.IndexOf(object value) {
				...
				return list.IndexOfValue((DbConnectionProvider)value);
			}
