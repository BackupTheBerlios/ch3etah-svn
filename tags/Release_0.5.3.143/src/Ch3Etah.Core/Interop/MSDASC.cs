...
namespace Ch3Etah.Core.Interop
{
	...
	{
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void RemoteGetProperties([In] uint cPropertyIDSets, [In] ref tagDBPROPIDSET rgPropertyIDSets, [In, Out] ref uint pcPropertySets, [Out] IntPtr prgPropertySets, [MarshalAs(UnmanagedType.Interface)] out IErrorInfo ppErrorInfoRem);
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void RemoteSetProperties([In] uint cPropertySets, [In] ref tagDBPROPSET rgPropertySets, [In] uint cTotalProps, out uint rgPropStatus, [MarshalAs(UnmanagedType.Interface)] out IErrorInfo ppErrorInfoRem);
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void Reset();
	}
