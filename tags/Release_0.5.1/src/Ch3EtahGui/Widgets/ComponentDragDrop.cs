...
namespace Ch3Etah.Gui.Widgets
{
	...
	public class TreeViewDragDrop : System.Windows.Forms.TreeView
	{
		...
		protected override void OnDragEnter(DragEventArgs e)
		{
			...
			Debug.WriteLine(this._formDrag.labelText.Size);
		}
		...
		protected override void OnDragDrop(DragEventArgs e)
		{
			...
			if( e.Data.GetDataPresent("System.Windows.Forms.TreeNode", false) )
			{
				...
				// Completa a ação desde que o nó de destino não seja da pasta FIELDS
				if (targetNode.Parent.Text == "Indexes" || targetNode.Text == "Indexes")
				{
