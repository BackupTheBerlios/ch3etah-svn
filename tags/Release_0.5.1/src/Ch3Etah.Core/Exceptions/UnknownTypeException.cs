...
{
	/// <summary>
	/// Thrown when a specified type is not found or cannot be loaded for some reason.	
	/// </summary>
	public class UnknownTypeException : ApplicationException
	{
		public UnknownTypeException() : base ("The specified type could not be loaded by the reflection engine.")
		{
		}
