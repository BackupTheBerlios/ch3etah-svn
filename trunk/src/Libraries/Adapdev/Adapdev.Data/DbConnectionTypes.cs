...
namespace Adapdev.Data {
	...
	[Serializable]
	public class DbConnectionTypes : IDictionary, ICloneable {

		#region Member Variables
		private const int DEFAULT_CAPACITY = 16;

		private string[] keys;
		private DbConnectionType[] values;
		private int count;
		...
		#region Constructors
		/// <summary>
		///		Initializes a new instance of the <see cref="DbConnectionTypes"/> class that is empty, 
		///		has the default initial capacity and is sorted according to the <see cref="IComparable"/> interface 
		///		implemented by each key added to the <b>DbConnectionTypes</b>.
		/// </summary>
		public DbConnectionTypes() {
			keys = new string[DEFAULT_CAPACITY];
			values = new DbConnectionType[DEFAULT_CAPACITY];
		...
		///		interface implemented by each key added to the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <param name="capacity">The initial number of elements that the <see cref="DbConnectionTypes"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public DbConnectionTypes(int capacity) {
			if (capacity < 0)
				throw new ArgumentOutOfRangeException("capacity", capacity, "Initial capacity cannot be less than zero.");

			keys = new string[capacity];
			values = new DbConnectionType[capacity];
			comparer = Comparer.Default;
		}
		...
		/// </param>
		public DbConnectionTypes(IComparer comparer) : this() {
			if (comparer != null)
		...
		/// <param name="capacity">The initial number of elements that the <see cref="DbConnectionTypes"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity"/> is less than zero.</exception>
		public DbConnectionTypes(IComparer comparer, int capacity) : this(capacity) {
			if (comparer != null)
				this.comparer = comparer;
		}

		/// <summary>
		///		Initializes a new instance of the <see cref="DbConnectionTypes"/> class that contains 
		...
		///		<para>-or-</para>
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="DbConnectionTypes"/>.</para>
		///	</exception>
		public DbConnectionTypes(IDictionary d) : this(d, null) {}
		...
		///		<para><pararef name="d"/> contains elements of a type not supported by <see cref="DbConnectionTypes"/>.</para>
		///	</exception>
		public DbConnectionTypes(IDictionary d, IComparer comparer)
		...
		#region Properties
		/// <summary>
		///		Gets and sets the value associated with a specific key in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <value>
		///		The <see cref="DbConnectionType"/> associated with <paramref name="key"/> in the <see cref="DbConnectionTypes"/>,
		...
		///		Callers must either catch this exception, or call the <see cref="DbConnectionTypes.Contains"/> method first to
		///		see if the key exists.
		/// </remarks>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="DbConnectionTypes"/>.
		/// </exception>
		/// <exception cref="NullReferenceException">
		///		<paramref name="key"/> is not found in the <see cref="DbConnectionTypes"/>.
		/// </exception>
		object IDictionary.this[object key] {
			...
			set {
				...
				if (!(value is DbConnectionType))
					throw new ArgumentException("The value must be of type: " + typeof(DbConnectionType).FullName, "value");

				this[(string)key] = (DbConnectionType)value;
			}
		}
		...
		///		<paramref name="key"/> is not found in the <see cref="DbConnectionTypes"/>.
		/// </exception>
		public virtual DbConnectionType this[string key] {
			get {
		...
		/// <summary>
		///		Gets or sets the capacity of the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <value>The number of elements that the <see cref="DbConnectionTypes"/> can contain.</value>
			...
			set {
				...
				if (value != keys.Length) {
					if (value > 0) {
						...
						DbConnectionType[] newValues = new DbConnectionType[value];
		...
		/// <summary>
		///		Gets the number of elements contained in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <value>The number of elements contained in the <see cref="DbConnectionTypes"/>.</value>
		...
		/// <summary>
		///		Gets a value indicating whether the <b>DbConnectionTypes</b> has a fixed size.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="DbConnectionTypes"/> has a fixed size; otherwise, <b>false</b>.
		...
		/// <summary>
		///		Gets a value indicating whether the <b>DbConnectionTypes</b> is read-only.
		/// </summary>
		/// <value>
		///		<b>true</b> if the <see cref="DbConnectionTypes"/> is read-only; otherwise, <b>false</b>.
		///		The default is <b>false</b>.
		/// </value>
		...
		/// <summary>
		///		Gets a value indicating whether access to the <b>DbConnectionTypes</b> is
		///		synchronized (thread-safe).
		/// </summary>
		/// <value>
		///		<b>true</b> if access to the the <see cref="DbConnectionTypes"/> is 
		...
		/// <summary>
		///		Gets the keys in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the keys in the <see cref="DbConnectionTypes"/>.</value>
		/// <remarks>
		///		<para>The <see cref="ICollection"/> is a read-only view of the keys in the 
		///		<see cref="DbConnectionTypes"/>. Modifications made to the underlying <b>DbConnectionTypes</b>
		...
		///		of the <b>DbConnectionTypes</b>.</para>
		///		<para>Similar to <see cref="DbConnectionTypes.GetKeyList"/>, but returns an <b>ICollection</b>
		...
		/// <summary>
		///		Gets an object that can be used to synchronize access to the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <value>An object that can be used to synchronize access to the <see cref="DbConnectionTypes"/>.</value>
		public virtual object SyncRoot {
			get { return this; }
		}

		/// <summary>
		///		Gets the values in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <value>An <see cref="ICollection"/> containing the values in the <see cref="DbConnectionTypes"/>.</value>
		/// <remarks>
		...
		///		of the <b>DbConnectionTypes</b>.</para>
		///		<para>Similar to <see cref="DbConnectionTypes.GetValueList"/>, but returns an <b>ICollection</b>
		///		instead of an <see cref="IList"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Adds an element with the specified key and value to the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <param name="key">The key of the element to add.</param>
		/// <param name="value">The value of the element to add.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		<para>An element with the specified <paramref name="key"/> already exists in the <see cref="DbConnectionTypes"/>.</para>
		///		<para>-or-</para>
		///		<para>Either the <paramref name="key"/> or the <paramref name="value"/> are not of a type supported by the <see cref="DbConnectionTypes"/>.</para>
		///		<para>-or-</para>
		///		<para>The <b>DbConnectionTypes</b> is set to use the <see cref="IComparable"/> interface,
		...
		///		<para>The <see cref="DbConnectionTypes"/> is read-only.</para>
		///		<para>-or-</para>
		///		<para>The <b>DbConnectionTypes</b> has a fixed size.</para>
		/// </exception>
		void IDictionary.Add(object key, object value) {
			...
			this.Add((string)key, (DbConnectionType)value);
		}
		...
		///		<para>The <b>DbConnectionTypes</b> has a fixed size.</para>
		/// </exception>
		public virtual void Add(string key, DbConnectionType value) {
			if (Object.ReferenceEquals(key, null)) // avoids compiler error for null check on value type
				throw new ArgumentNullException("key", "The key cannot be null.");
		...
		public virtual void Add(DbConnectionType value) {
		...
		/// <summary>
		///		Removes all elements from the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="DbConnectionTypes"/> is read-only.</para>
		///		<para>-or-</para>
		...
		/// <summary>
		///		Creates a shallow copy of the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <returns>A shallow copy of the <see cref="DbConnectionTypes"/>.</returns>
		public virtual object Clone() {
			DbConnectionTypes newList = new DbConnectionTypes(count);
		...
		/// <summary>
		///		Determines whether the <b>DbConnectionTypes</b> contains a specific key.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="DbConnectionTypes"/>.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="key"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		///		The <paramref name="key"/> is not of a type supported by the <see cref="DbConnectionTypes"/>.
		/// </exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="DbConnectionTypes"/> contains an element with the specified key; 
		///		otherwise, <b>false</b>.
		///	</returns>
		...
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <returns>
		///		<b>true</b> if the <see cref="DbConnectionTypes"/> contains an element with the specified 
		...
		/// <summary>
		///		Determines whether the <b>DbConnectionTypes</b> contains a specific value.
		/// </summary>
		/// <param name="value">The value to locate in the <see cref="DbConnectionTypes"/>.</param>
		/// <returns>
		///		<b>true</b> if the <see cref="DbConnectionTypes"/> contains an element with the specified 
		///		<paramref name="value"/>; otherwise, <b>false</b>.
		/// </returns>
		public virtual bool ContainsValue(DbConnectionType value) {
			return (IndexOfValue(value) >= 0);
		}

		/// <summary>
		///		Copies the <see cref="DbConnectionTypes"/> elements to a one-dimensional <see cref="System.Array"/>
		///		instance at the specified index.
		/// </summary>
		/// <param name="array">
		///		The one-dimensional <see cref="System.Array"/> that is the destination of the
		///		<see cref="DictionaryEntry"/> objects copied from <see cref="DbConnectionTypes"/>.
		...
		///		<para>-or-</para>
		///		<para>The number of elements in the source <see cref="DbConnectionTypes"/> is greater than the 
		///		available space from <paramref name="arrayIndex"/> to the end of the destination <paramref name="array"/>.</para>
		/// </exception>
		/// <exception cref="InvalidCastException">
		///		The type of the source <see cref="DbConnectionTypes"/> cannot be cast automatically to the type
		...
		/// <summary>
		///		Gets the value at the specified index of the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the value to get.</param>
		/// <returns>The value at the specified index of the <see cref="DbConnectionTypes"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="DbConnectionTypes"/>.
		/// </exception>
		public virtual DbConnectionType GetByIndex(int index) {
		...
		/// <summary>
		///		Returns an <see cref="IEnumerator"/> that can iterate through the <b>DbConnectionTypes</b>.
		/// </summary>
		...
		///		<b>DbConnectionTypes</b>.		
		/// </summary>
		/// <returns>An <see cref="IDictionaryEnumerator"/> for the <see cref="DbConnectionTypes"/>.</returns>
		public virtual IDictionaryEnumerator GetEnumerator() {
			return new SortedListEnumerator(this, 0, count, SortedListEnumerator.DictEntry);
		}

		/// <summary>
		///		Gets the key at the specified index of the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <param name="index">The zero-based index of the key to get.</param>
		/// <returns>The key at the specified index of the <see cref="DbConnectionTypes"/>.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="DbConnectionTypes"/>.
		/// </exception>
		...
		///		Gets the keys in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the keys in the <see cref="DbConnectionTypes"/>.</returns>
		/// <remarks>
		...
		///		of the <b>DbConnectionTypes</b>.</para>
		///		<para>Similar to <see cref="DbConnectionTypes.Keys"/>, but returns an <b>IList</b>
		...
		///		Gets the values in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <returns>An <see cref="IList"/> containing the values in the <see cref="DbConnectionTypes"/>.</returns>
		/// <remarks>
		...
		///		of the <b>DbConnectionTypes</b>.</para>
		///		<para>Similar to <see cref="DbConnectionTypes.Values"/>, but returns an <b>IList</b>
		///		instead of an <see cref="ICollection"/>.</para>
		/// </remarks>
		...
		/// <summary>
		///		Returns the zero-based index of the specified key in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="DbConnectionTypes"/>.</param>
		/// <returns>
		///		The zero-based index of <paramref name="key"/>, if <paramref name="key"/> is found in
		///		the <see cref="DbConnectionTypes"/>; otherwise, -1.
		/// </returns>
		/// <exception cref="ArgumentNullException"><paramref name="key"/> is a null reference.</exception>
		/// <exception cref="InvalidOperationException">The comparer throws an exception.</exception>
		/// <remarks>
		///		<para>The elements of a <see cref="DbConnectionTypes"/> are sorted by the keys either 
		///		according to a specific <see cref="IComparer"/> implementation specified when the 
		///		<see cref="DbConnectionTypes"/> is created or according to the <see cref="IComparable"/> 
		...
		///		it is inserted into <see cref="DbConnectionTypes"/> in the correct sort order, and the 
		...
		///		removed from the <see cref="DbConnectionTypes"/>.</para>
		///		<para>This method uses a binary search algorithm; therefore, the average execution time is 
		///		proportional to Log2(<i>n</i>), where <i>n</i> is <see cref="DbConnectionTypes.Count"/>.</para>
		/// </remarks>
		...
		/// <remarks>
		///		<para>The index sequence is based on the sort sequence. When an element is added, 
		///		it is inserted into <see cref="DbConnectionTypes"/> in the correct sort order, and 
		...
		///		elements are added or removed from the <see cref="DbConnectionTypes"/>.</para>
		///		<para>The values of the elements of the <see cref="DbConnectionTypes"/> are compared to the 
		...
		///		proportional to <see cref="DbConnectionTypes.Count"/>.</para>
		/// </remarks>
		public virtual int IndexOfValue(DbConnectionType value) {
			return Array.IndexOf(values, value, 0, count);
		}

		/// <summary>
		///		Removes the element with the specified key from the <b>DbConnectionTypes</b>.
		/// </summary>
		...
		/// </exception>
		/// <remarks>
		///		If the <see cref="DbConnectionTypes"/> does not contain an element with the specified key,
		///		the <b>DbConnectionTypes</b> remains unchanged. No exception is thrown.
		/// </remarks>
		...
		/// <summary>
		///		Removes the element at the specified index of the <b>DbConnectionTypes</b>.
		/// </summary>
		...
		public virtual void RemoveAt(int index) {
			...
			DbConnectionType[] tempVal = new DbConnectionType[1];
		...
		/// <summary>
		///		Replaces the value at a specific index in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <param name="index">The zero-based index at which to save <paramref name="value"/>.</param>
		/// <param name="value">The <see cref="DbConnectionType"/> to save into the <see cref="DbConnectionTypes"/>.</param>
		/// <exception cref="ArgumentOutOfRangeException">
		///		<paramref name="index"/> is outside the range of valid indices for the <see cref="DbConnectionTypes"/>.
		/// </exception>
		/// <remarks>
		...
		///		elements are added or removed from the <see cref="DbConnectionTypes"/>.</para>
		/// </remarks>
		public virtual void SetByIndex(int index, DbConnectionType value) {
			if (index < 0 || index >= count)
				throw new ArgumentOutOfRangeException("index", index, "The index is outside the range of valid indices.");
		...
		/// <summary>
		///		Returns a synchronized (thread-safe) wrapper for the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <param name="list">The <see cref="DbConnectionTypes"/> to synchronize.</param>
		/// <returns>A synchronized (thread-safe) wrapper for the <see cref="DbConnectionTypes"/>.</returns>
		/// <exception cref="ArgumentNullException"><paramref name="list"/> is a null reference.</exception>
		public static DbConnectionTypes Synchronized(DbConnectionTypes list) {
			if (list == null)
		...
		/// <summary>
		///		Sets the capacity to the actual number of elements in the <b>DbConnectionTypes</b>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		///		<para>The <see cref="DbConnectionTypes"/> is read-only.</para>
		///		<para>-or-</para>
		...
		private void Insert(int index, string key, DbConnectionType value) {
		...
		[Serializable]
			private class SyncSortedList : DbConnectionTypes, IDictionary {
			private DbConnectionTypes list;
			private object root;

			internal SyncSortedList(DbConnectionTypes list) {
				this.list = list;
			...
			public override DbConnectionType this[string key] {
				get {
					lock (root)
						return list[key];
				}
			...
			public override void Add(string key, DbConnectionType value) {
				lock (root)
					list.Add(key, value);
			}
			...
			public override bool ContainsValue(DbConnectionType value) {
				lock (root)
			...
			public override DbConnectionType GetByIndex(int index) {
				lock (root)
			...
			public override int IndexOfValue(DbConnectionType value) {
				lock (root)
			...
			public override void SetByIndex(int index, DbConnectionType value) {
				lock (root)
		...
		[Serializable]
			...
			private DbConnectionTypes list;
			private string key;
			private DbConnectionType value;
			private int index;
			...
			internal SortedListEnumerator(DbConnectionTypes list, int index, int count, int returnType) {
				this.list = list;
				this.index = index;
			...
			public virtual DbConnectionType Value {
				get {
					CheckState();
					return value;
				}
		...
		[Serializable]
			...
			internal KeyList(DbConnectionTypes list) {
				this.list = list;
			}
		...
		[Serializable]
			...
			internal ValueList(DbConnectionTypes list) {
				this.list = list;
			}
			...
			bool IList.Contains(object value) {
				...
				return list.ContainsValue((DbConnectionType)value);
			}

			public virtual bool Contains(DbConnectionType value) {
				return list.ContainsValue(value);
			}
			...
			object IList.this[int index] {
				...
				set {
					...
					list.SetByIndex(index, (DbConnectionType)value);
				}
			}

			public virtual DbConnectionType this[int index] {
				get {
					return list.GetByIndex(index);
				}
				set {
			...
			int IList.IndexOf(object value) {
				...
				return list.IndexOfValue((DbConnectionType)value);
			}

			public virtual int IndexOf(DbConnectionType value) {
				return list.IndexOfValue(value);
			}
		...
		public static DbConnectionType UnknownConnectionType () {
			return new DbConnectionType("UnKnown", DbType.UNKNOWN, DbProviderType.UNKNOWN);
		}
		#endregion
	}
}
